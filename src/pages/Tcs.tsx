  ...
  return (
    <div>
      ...
      <article className={styles.container}>
        ...
        <p>
          Welcome to the Waydus iOS mobile application (our “APP”). These Terms
          and Conditions (these “Terms”) constitute a legal agreement between
          you the End-User (“End-User” or “you”) and Waydus Ltd of 124 City
          Road, London, EC1V 2NX , UK (“we”, “us”, or “our”) governing the use
          of our APP and our Services. We license use of our APP to you on the
        ...
        <ol>
          <li>
            ...
            <ol>
              <li>
                ...
                by any provisions or obligations with regard to our APP, such as
                warranty, liability, maintenance and support thereof. We, not
                Apple Inc., are solely responsible for our APP and the content
                thereof.
              </li>
              <li>
              ...
              <li>
                ...
                utilises the Apple iOS operating systems and in accordance with
                the usage rules set forth in Apple Inc.’s Terms of Service;
              </li>
              <li>
                We are responsible for providing any maintenance and support
                services with respect to the APP as specified in these Terms or
              ...
              <li>
                You must comply with Apple Inc.’s Terms of agreement when using
                the APP,
              </li>
              <li>
                ...
                the terms and conditions in these Terms against you as a
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                supported Apple branded Products that you own or control and as
                permitted by the Usage Rules set forth in section Apple Inc.’s
                Terms of Service.
              </li>
              <li>
                This license will also govern any updates of our APP provided by
                us that replace, repair, and/or supplement our APP, unless a
              ...
              <li>
                ...
                of our APP, or any part thereof.
              </li>
              <li>
                You may not copy or alter our APP or portions thereof. You may
                create and store copies only on devices that you own or control
                for backup keeping under the terms of these Terms, and “Apple
                App Store” Terms of Service, and any other terms and conditions
                that apply to the device or software used.
              </li>
              ...
              <li>
                ...
                third-party terms. When using our APP, you must ensure that you
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                modified/new versions of the firmware and new hardware. You are
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                You are fully responsible for your content uploaded to our APP.
                We will not be responsible, or liable to any third party, for:
                <ol>
                  <li>
                    the content or accuracy of any content or data uploaded by
                    you, by us on your behalf, or any other user of our APP; or
                  </li>
                  <li>
              ...
              <li>
                We will only use the content uploaded by you for the purposes of
                carrying out the Services, carrying out our obligations in this
                Agreement and any other purpose expressly set out in this
                Agreement or otherwise agreed between us. We will not otherwise
                disclose or distribute the content uploaded by you, save for
                when required by law, a court of competent jurisdiction or any
              ...
              <li>
                ...
                learning. Any such content shall be anonymised and used only for
                the purposes of improving the Services and our response to users
                of the APP.
              </li>
              <li>
              ...
              <li>
                We have the right to delete any content uploaded to our APP if,
                in our opinion, it does not comply with the content standards
                set out by us.
              </li>
            </ol>
            <br />
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                You are required to inspect our APP immediately after installing
                it and notify us about issues discovered without delay. The
                defect report will be taken into consideration and further
                investigated if it has been mailed within a period of seven (7)
          ...
          <li>
            ...
            <br />
            <p>
              The license is valid until terminated by us or by you. Your rights
              under this license will terminate automatically and without notice
              from us if you fail to adhere to any term(s) of this license. Upon
              License termination, you shall stop all use of our APP, and
              destroy all copies, full or partial, of our APP.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                disputes or claims in connection therewith, are governed by the
                law of England and Wales. In the event of any such disputes or
                claims in connection with these Terms, you agree to first engage
                in good faith discussions with us to resolve such dispute or
                claim. If such dispute or claim is not resolved within sixty
                (60) days, we both irrevocably submit to the exclusive
